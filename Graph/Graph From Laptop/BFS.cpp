...
bool B_F_S(vector <int> Graph[], int root, int destination);
...
int main()
{
    ...
    cout << "Print Node Label By Label : " << endl;
    if(B_F_S(Graph, root, destination) == true){
...
bool B_F_S(vector <int> Graph[], int root, int destionation)
{
    queue <int> q;
    int i, n, m;
